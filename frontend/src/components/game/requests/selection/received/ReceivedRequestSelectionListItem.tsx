...
export interface ReceivedRequestSelectionListItemProps {
	request: GameRequestType;
	select: (value: string) => void;
	selected: string | undefined;
}

const ReceivedRequestSelectionListItem = ({
	request,
	select,
	selected,
}: ReceivedRequestSelectionListItemProps) => {
	const { username, nickname, avatar, firstName, lastName, eloRating, level } = request.sender;
...
export default ReceivedRequestSelectionListItem;
