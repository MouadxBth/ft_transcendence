...
export interface ChannelInvitedListItemProps {
	channel: ChannelType;
	select: (value: string) => void;
	selected: string;
}

const ChannelInvitedListItem = ({ channel, select, selected }: ChannelInvitedListItemProps) => {
...
export default ChannelInvitedListItem;
