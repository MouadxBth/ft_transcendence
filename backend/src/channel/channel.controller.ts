...
export class ChannelController {
	...
	@ApiOperation({summary: "Fetch a Channel by channelname", description: "Used to fetch a Channel by channelname"})
	...
	@ApiOperation({summary: "Update a Channel by channelname", description: "Used to update a Channel by channelname"})
	...
	@ApiOperation({summary: "Delete a Channel by channelname", description: "Used to delete a Channel by channelname"})
